...
You will find a dataset prepared for you if you modify the **bolded** portion of the following  link:
...
```{r, echo=FALSE}
df <- read.csv('https://raw.githubusercontent.com/MetodesEmpirics/MetodesEmpirics.github.io/main/material/2022q3/session06/data/csvs/u103672.csv')
head(df)
```
...
Help your colleague analze the data from her experiments! Remember to round all answers to the second decimal after the comma.
